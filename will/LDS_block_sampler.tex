...
\end{align*}
Where $\Omega_a = S_{axx}-XS_{bxx}^{-1}X'$ and $\Omega_b = S_{bxx}-X'S_{axx}^{-1}X$. The quadratic form can then be expressed as
\begin{align*}
S_{yx}S_{xx}^{-1}S_{yx}' &= S_{yx}\begin{pmatrix}\Omega_a^{-1} & -S_{axx}^{-1}X\Omega_b^{-1}\\-S_{bxx}^{-1}X'\Omega_a^{-1} & \Omega_b^{-1}\end{pmatrix}\begin{pmatrix}XY'+K_AM_A'\\Y'+K_BM_B'\end{pmatrix}\\
&=(YX'\begin{pmatrix}\Omega_a^{-1}(Y'+K_BM_B') -S_{axx}^{-1}X\Omega_b^{-1}(XY'+K_AM_A')\\\Omega_b^{-1}(XY'+K_AM_A') -S_{bxx}^{-1}X'\Omega_a^{-1}(Y'+K_BM_B')\end{pmatrix}\\
\end{align*}
