...
```{r}
init_mniw_hyper<-function(y,D=ncol(y)){
  #given an nT by D matrix of observations "y" (each row is an observation)
  ...
  # nu0 = prior degrees of freedom on Sigma, the transition model covariance/noise
  # Delta0 = prior scale matrix for Sigma
