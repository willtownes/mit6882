...
For each scenario, we first used the true dynamical parameters and mode sequence to learn the posterior over the hidden states $x_{1:T}$. Then, we tried learning both the hidden states and the dynamical parameters.
